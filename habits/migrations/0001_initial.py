# Generated by Django 4.2 on 2024-09-01 17:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interval', models.SmallIntegerField(blank=True, null=True, verbose_name='Периодичность (дней)')),
                ('reward', models.CharField(blank=True, max_length=255, null=True, verbose_name='Вознаграждение')),
                ('execution_time', models.SmallIntegerField(blank=True, null=True, verbose_name='Время на выполнение (в секундах)')),
